...
public class tiledMultiplicationTest {
    ...
    @Test
    public void tiledMultiplicationTest_m2_s2() {
        Matrix actual = Matrix.tiledMultiplication(m2, m2, 2);
        Matrix expected = m2_squared;
        assertEquals(expected, actual);
    }
    @Test
    public void tiledMultiplicationTest_m2_s2_wrong() {
        Matrix actual = Matrix.tiledMultiplication(m2, m2, 2);
    ...
    @Test
    public void tiledMultiplicationTest_m4_s2() {
        Matrix actual = Matrix.tiledMultiplication(m4, m4, 2);
        Matrix expected = m4_squared;
        assertEquals(expected, actual);
    }
    @Test
    public void tiledMultiplicationTest_m4_s2_wrong() {
        Matrix actual = Matrix.tiledMultiplication(m4, m4, 2);
    ...
    @Test
    public void tiledMultiplicationTest_m4_s4() {
        Matrix actual = Matrix.tiledMultiplication(m4, m4, 4);
        Matrix expected = m4_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void tiledMultiplicationTest_m8_s2() {
        Matrix actual = Matrix.tiledMultiplication(m8, m8, 2);
        Matrix expected = m8_squared;
        assertEquals(expected, actual);
    }
    @Test
    public void tiledMultiplicationTest_m8_s2_wrong() {
        Matrix actual = Matrix.tiledMultiplication(m8, m8, 2);
    ...
    @Test
    public void tiledMultiplicationTest_m8_s4() {
        Matrix actual = Matrix.tiledMultiplication(m8, m8, 4);
        Matrix expected = m8_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void tiledMultiplicationTest_m8_s8() {
        Matrix actual = Matrix.tiledMultiplication(m8, m8, 8);
        Matrix expected = m8_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void tiledMultiplicationTest_m16_s2() {
        Matrix actual = Matrix.tiledMultiplication(m16, m16, 2);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }
    @Test
    public void tiledMultiplicationTest_m16_s2_wrong() {
        Matrix actual = Matrix.tiledMultiplication(m16, m16, 2);
    ...
    @Test
    public void tiledMultiplicationTest_m16_s4() {
        Matrix actual = Matrix.tiledMultiplication(m16, m16, 4);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void tiledMultiplicationTest_m16_s8() {
        Matrix actual = Matrix.tiledMultiplication(m16, m16, 8);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void tiledMultiplicationTest_m16_s16() {
        Matrix actual = Matrix.tiledMultiplication(m16, m16, 16);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }
