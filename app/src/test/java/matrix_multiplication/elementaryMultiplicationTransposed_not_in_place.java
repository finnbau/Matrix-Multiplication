...
public class elementaryMultiplicationTransposed_not_in_place {
    ...
    public void elementaryMultiplicationTest_m2() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m2, m2, 1);
    ...
    public void elementaryMultiplicationTest_m4() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m4, m4, 2);
    ...
    @Test
    public void elementaryMultiplicationTest_m8_s2() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m8, m8, 2);
    ...
    public void elementaryMultiplicationTest_m8_s4() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m8, m8, 4);
        Matrix expected = m8_squared;
        assertEquals(expected, actual);
    }

    @Test
    public void elementaryMultiplicationTest_m16_s2() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m16, m16, 2);
    ...
    public void elementaryMultiplicationTest_m16_s4() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m16, m16, 4);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }
    @Test
    ...
    @Test
    public void elementaryMultiplicationTest_m16_s8() {
        Matrix actual = Matrix.elementaryMultiplicationTransposed(m16, m16, 8);
        Matrix expected = m16_squared;
        assertEquals(expected, actual);
    }
